...
var food_set_ops = {
    ...
    eventBind: function () {
        ...
        $(".wrap_food_set .upload_pic_wrap input[name=icon]").change(function () {
        ...
        $(".wrap_food_set .save").click(function () {
            ...
            var bar_code_target = $(".wrap_food_set input[name=bar_code]");
            var bar_code = bar_code_target.val();
